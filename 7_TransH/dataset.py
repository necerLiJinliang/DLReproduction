...
class TransHDataset(Dataset):
    def __init__(
        ...
        advance=False,
        num_neg_samples=10,
        hpt_file="7_TransH/dataset/FB15k/hpt_r.pkl",
        tph_file="7_TransH/dataset/FB15k/tph_r.pkl",
    ):
        super(TransHDataset, self).__init__()
...
if __name__ == "__main__":
    get_meta_data(data_folder_path="7_TransH/dataset/FB15k/")
